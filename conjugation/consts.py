...
MOODS_TENSES = [
    ...
    ('indicative_composé-past', 'Indicatif Passe Compose'),
    ('indicative_imperfect', 'Indicatif Imparfait'),
    ('indicative_pluperfect', 'Indicatif Plus Que Parfait'),
    ('indicative_simple-past', 'Indicatif Passe Simple'),
    ('indicative_antérieur-past', 'Indicatif Passe Antérieur'),
    ('indicative_future', 'Indicatif Future Simple'),
    ('indicative_antérieur-future', 'Indicatif Future Antérieur'),
