...
$(document).ready(function(){"true"===window.localStorage.getItem("long_list")&&see_more();var b=location.href.replace(/\/$/,"");if(location.hash){var a=b.split("#");$('.verb-form-pill a[data-target=".'+a[1]+'"]').tab("show")}$('.verb-form-pill a[data-toggle="pill"]').on("click",function(){var a=$(this).attr("data-target").replace(/\./,"#");a="#form0"===a?b.split("#")[0]:b.split("#")[0]+a;history.replaceState(null,null,a)});$(".play-pause-icon").each(function(){$(this).addClass(NORMAL_CLASS);this.addEventListener("click",
function(){if(void 0!==audio&&!audio.paused&&(audio.pause(),audio.currentTime=0,changeClassTo(this,NORMAL_CLASS),audio.attributes["data-key"]===this.attributes["data-key"].value))return;pollyListen(this,this.attributes["data-key"].value)})});$(".nav-pills > li > a").each(function(){this.addEventListener("click",function(){".form0"!==this.attributes["data-target"].value?$(".play-pause-icon").hide():$(".play-pause-icon").show()})})});
