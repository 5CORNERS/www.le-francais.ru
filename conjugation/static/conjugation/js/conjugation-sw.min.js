...
d)})};d.all=function(a){var c=$jscomp.makeIterator(a),e=c.next();return e.done?b([]):new d(function(a,d){function f(b){return function(c){g[b]=c;h--;0==h&&a(g)}}var g=[],h=0;do g.push(void 0),h++,b(e.value).callWhenSettled_(f(g.length-1),d),e=c.next();while(!e.done)})};return d},"es6","es3");$jscomp.polyfill("Object.is",function(a){return a?a:function(a,b){return a===b?0!==a||1/a===1/b:a!==a&&b!==b}},"es6","es3");
$jscomp.polyfill("Array.prototype.includes",function(a){return a?a:function(a,b){var c=this;c instanceof String&&(c=String(c));var d=c.length;b=b||0;for(0>b&&(b=Math.max(b+d,0));b<d;b++){var g=c[b];if(g===a||Object.is(g,a))return!0}return!1}},"es7","es3");
$jscomp.checkStringArgs=function(a,c,b){if(null==a)throw new TypeError("The 'this' value for String.prototype."+b+" must not be null or undefined");if(c instanceof RegExp)throw new TypeError("First argument to String.prototype."+b+" must not be a regular expression");return a+""};$jscomp.polyfill("String.prototype.includes",function(a){return a?a:function(a,b){return-1!==$jscomp.checkStringArgs(this,a,"includes").indexOf(a,b||0)}},"es6","es3");
var CACHE_NAME="le_francais-conjugation-cache-v18",urlsToCache="/static/conjugation/css/conjugation.min.css /static/conjugation/js/conjugation.min.js /static/conjugation/images/ui-anim_basic_16x16.gif /static/lib/jquery-ui-1.12.1.custom/jquery-ui.min.css /static/js/le_francais.min.js /static/css/le_francais.min.css /android-chrome-192x192.png /android-chrome-512x512.png /static/components/css/bootstrap.css /static/components/css/bootstrap-select.css /static/components/css/bootstrap-treeview.css /static/components/css/font-awesome.css /static/components/js/bootstrap.js /static/components/js/bootstrap-select.js /static/components/js/bootstrap-treeview.min.js /static/components/js/jquery.js".split(" ");
self.addEventListener("install",function(a){a.waitUntil(caches.delete(CACHE_NAME).then(function(){caches.open(CACHE_NAME).then(function(a){console.log("Opened cache");return a.addAll(urlsToCache)})}))});self.addEventListener("activate",function(a){var c=[CACHE_NAME];a.waitUntil(caches.keys().then(function(a){return Promise.all(a.map(function(a){if(-1===c.indexOf(a))return caches.delete(a)}))}))});
self.addEventListener("fetch",function(a){a.respondWith(caches.match(a.request).then(function(c){return c?c:fetch(a.request).then(function(b){if(!b||200!==b.status||"basic"!==b.type||"GET"!==a.request.method||a.request.url.includes("/api/")||!a.request.url.includes("/static/")&&!a.request.url.includes("/verbs_autocomplete/"))return b;var c=b.clone();caches.open(CACHE_NAME).then(function(b){b.put(a.request,c)});return b})}))});
