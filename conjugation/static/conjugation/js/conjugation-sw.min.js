...
self.addEventListener("fetch",function(a){a.respondWith(caches.match(a.request).then(function(c){return c?c:fetch(a.request).then(function(b){if(!b||200!==b.status||"basic"!==b.type||"GET"!==a.request.method||a.request.url.includes("/conjugation/")&&a.request.url.includes("/conjugaison/")&&!a.request.url.includes("/static/"))return b;var c=b.clone();caches.open(CACHE_NAME).then(function(b){b.put(a.request,c)});return b})}))});
