...
class Verb(models.Model):
	...
	def employs(self):
		...
		s += 'в составных временах спрягается со вспомогательным глаголом <span class="arnaud-comment" data-container="body" data-html="true" data-content="Почему некоторые глаголы спрягаются с ÊTRE — этому есть <a href=\'/oh-la-la/conjugue_avec_etre/?utm_campaign=conjugeur&utm_medium=button&utm_source=%C3%8ATRE\'>простое и изящное объяснение</a>. :)" data-placement="top" data-toggle="popover"><b>être</b></span>, ' if self.conjugated_with_etre and not self.conjugated_with_avoir else ''
		s += 'в составных временах спрягается как со вспомогательным глаголом <span class="arnaud-comment" data-container="body" data-html="true" data-content="Почему некоторые глаголы спрягаются с ÊTRE — этому есть <a href=\'/oh-la-la/conjugue_avec_etre/?utm_campaign=conjugeur&utm_medium=button&utm_source=%C3%8ATRE\'>простое и изящное объяснение</a>. :)" data-placement="top" data-toggle="popover"><b>être</b></span>, так и с глаголом <b>avoir</b> — в зависимости от наличия прямого дополнения, ' if self.conjugated_with_avoir and self.conjugated_with_etre else ''
