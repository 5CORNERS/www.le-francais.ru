...
(d.removeClass(b.mute),c.volume=A):(d.addClass(b.mute),A=c.volume,c.volume=0);return!1});p.on(v,function(a){H(a);p.on(y,function(a){H(a)})}).on(B,function(){p.off(y)})}else d.addClass(b.mini);typeof n!==typeof g&&!1!==n&&(typeof localStorage["lecon-"+n]!==typeof g&&"undefined"!==localStorage["lecon-"+n]&&(c.currentTime=+localStorage["lecon-"+n]),l.addClass(b.mini).addClass("pull-right"),l.attr("number",l.find("audio").attr("number")),l.find("audio").remove(),a("nav.navbar > .container > .d-flex.order-2 > .navbar-nav").append(l),
