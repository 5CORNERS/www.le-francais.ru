...
C=!1)))}if("audio"!=b(this).prop("tagName").toLowerCase())return!1;var n=b(this),u=n.attr("src"),x=n.get(0).getAttribute("autoplay"),p=n.get(0).getAttribute("loop"),t=!1,A=n.get(0).getAttribute("set-time"),D=!0===n.data("strict"),P=!0===n.data("forbidBackground");x=""===x||"autoplay"===x;p=""===p||"loop"===p;"undefined"===typeof u?n.find("source").each(function(){u=b(this).attr("src");if("undefined"!==typeof u&&I(u))return t=!0,!1}):I(u)&&(t=!0);var d=b('<div class="'+g.classPrefix+'">'+(t?b("<div>").append(n.eq(0).clone()).html():
