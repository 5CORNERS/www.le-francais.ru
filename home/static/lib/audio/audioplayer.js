        ...
        this.each(function () {
            ...
            if (isSupport) {
                ...
                if ((typeof lesson_number !== typeof undefined) && (lesson_number !== false)) {
                    ...
                    // $menuPlayer.prepend($(`<div class="audioplayer-time audioplayer-time-duration" id="menuPlayerDuration">...</div>`))
                    // $menuPlayer.prepend($('<div class="audioplayer-time audioplayer-time-divider">/</div>'))
                    $menuPlayer.prepend($(`<div class="audioplayer-time audioplayer-time-current" id="menuPlayerCurrent">00:00</div>`))
                    ...
                    // theAudio.addEventListener('loadeddata', function () {
                    //     $menuPlayer.find('#menuPlayerDuration').text(secondsToTime(theAudio.duration))
                    // })
                ...
                theAudio.addEventListener('timeupdate', function () {
                    ...
                    $menuPlayer.find('#menuPlayerCurrent').text(secondsToTime(theAudio.currentTime))
