...
$("a#tab-verbs").one("show.bs.tab",function(){reloadPage(LESSON_NUMBER,"verbs")});$("a#tab-my-words").one("show.bs.tab",function(){reloadPage(LESSON_NUMBER,"my-words")});var c=window.navigator.userAgent,d=!!c.match(/iPad/i)||!!c.match(/iPhone/i),e=!!c.match(/WebKit/i),g=d&&e&&!c.match(/CriOS/i);if(NEED_PAYMENT){var f=function(a){switch(a){case "tab":case "download":case "ended":a=$("#lesson-audio")[0];localStorage["lecon-{{ self.lesson_number }}"]=a.duration-5;IS_AUTHENTICATED?saw_message?$("#lesson-not-activated-simple-modal").modal("show"):
$("#lesson-not-activated-details-continue-modal").modal("show"):$("#listen-login-required-modal").modal("show");break;case "button":saw_message?f("proceed"):$("#lesson-not-activated-details-activate-modal").modal("show");break;case "saw":b("make_true");break;case "proceed":userlesson||h()}},h=function(){$(".success-message").hide();$(".fail-message").hide();$(".minus-cups").hide();$(".unsofficiant-cups-credit").hide();$(".waiting-message").show();$("#lesson-activated-modal").modal("show");$.ajax({type:"POST",
url:Urls["activate:activate_lesson"](),data:{csrfmiddlewaretoken:CSRF_TOKEN,lesson_number:LESSON_NUMBER},datatype:"json",cache:!1,headers:{"cache-control":"no-cache"},async:!g,success:function(a){"SUCCESS"===a.result?(a=Math.floor(1E3*Math.random())%4,console.log(a),a="https://files.le-francais.ru/sound/"+activateSounds[a],$('<audio class="sound-player" autoplay="autoplay" style="display:none;"><source src="'+a+'" /><embed src="'+a+'" hidden="true" autostart="true" loop="false"/></audio>').appendTo("body")[0].play(),
window.location.href=window.location.pathname+"?"+$.param({modal_open:"lesson-activated-modal"})):"ZERO_CUPS"===a.result?($(".waiting-message").hide(),$(".unsofficiant-cups").show(),0>cups_amount&&0===cups_credit&&($("#activated-dismiss-button").hide(),$("#activated-unsofficiant-cups-button").hide(),$(".unsofficiant-cups-credit").show())):"ALREADY"===a.result?($(".waiting-message").hide(),$(".already-activated").show()):"NOT_AUTH"===a.result&&($(".waiting-message").hide(),$(".login-need").show())}})};
$("[data-saw-proceed]").on("click",function(){f("saw");setTimeout(f("proceed"),1E3)});activateSounds=["composter-01.mp3","composter-02.mp3","composter-03.mp3","composter-04.mp3"];if(!userlesson&&must_pay||NEED_PAYMENT&&!IS_AUTHENTICATED)window.addEventListener("lessonPlayerReady",function(){$(".audioplayer-download-button")[0].addEventListener("click",function(){f("download")});$("#lesson-audio")[0].addEventListener("ended",function(){f("ended")})}),$("[data-activate-lesson]").click(function(){f($(this).data("activate-lesson"))}),
$("#tab-flash-cards").removeAttr("data-toggle"),$("#tab-exercises-de-lesson").removeAttr("data-toggle"),$("#tab-exercise").removeAttr("data-toggle"),$("#tab-flash-cards").click(function(a){a.preventDefault();f("tab")}),$("#tab-exercises-de-lesson").click(function(a){a.preventDefault();f("tab")}),$("#tab-exercise").click(function(a){a.preventDefault();f("tab")})}else if(!IS_AUTHENTICATED&&5<LESSON_NUMBER)$(window).one("lessonPlayerReady",function(){$(".audioplayer-download-button").on("click",function(a){a.preventDefault();
$.ajax({url:Urls["modal:download_login_required"](),type:"GET",data:{redirect_url:window.location.pathname},datatype:"html",success:function(a){$(a).modal("show")}})})});$(".coffee-proceed").on("click",function(){$(".modal").modal("hide");$.ajax({type:"POST",url:Urls["coffee:give_me_a_coffee"](),data:{lesson_number:LESSON_NUMBER,csrfmiddlewaretoken:CSRF_TOKEN},async:!g,datatype:"json",cache:!1,headers:{"cache-control":"no-cache"},success:function(b){"SUCCESS"===b.result?((new Audio(COFFEE_SOUND_URL)).play(),
$("#give-me-a-coffee-success-message").html(b.description),$("#give-me-a-coffee-complete-modal").modal("show"),a(),$("#lessonAudioBlock").find(".audioplayer-download-button").attr("href",LESSON_LISTEN_URL).off(".strict"),userlesson=!0,reloadPage(LESSON_NUMBER)):"ALREADY"===b.result?($("#give-me-a-coffee-fail-message").html(b.description),$("#give-me-a-coffee-fail-modal").modal("show"),a(),reloadPage(LESSON_NUMBER)):($("#give-me-a-coffee-fail-message").html(b.description),$("#give-me-a-coffee-fail-modal").modal("show"))},
error:function(a,b){$("#give-me-a-coffee-fail-message").html(b);$("#give-me-a-coffee-fail-modal").modal("show")}})});addEventListener("strictDownload",function(a){!0!==!NEED_PAYMENT||!0!==must_pay||userlesson||$("#strictDownloadModal").modal("show")});addEventListener("unhiddenWasPlaying",function(a){$("#hiddenWasListeningModal").modal("show")});$("#unhiddenWasPlaying").click(function(a){$("#lessonAudioBlock").find("#playpause").click()});$("#strictDownloadModelWhyThis").popover({content:'<p>\u041c\u044b \u043f\u043e\u0434\u0434\u0435\u0440\u0436\u0438\u0432\u0430\u0435\u043c \u0438 \u0443\u043b\u0443\u0447\u0448\u0430\u0435\u043c \u043f\u0440\u043e\u0435\u043a\u0442 \u0441\u0432\u043e\u0438\u043c\u0438 \u0441\u0438\u043b\u0430\u043c\u0438. \u0427\u0442\u043e\u0431\u044b \u043f\u0440\u043e\u0434\u043e\u043b\u0436\u0430\u0442\u044c\n    \u0440\u0430\u0431\u043e\u0442\u0443 \u043d\u0430\u0434 \u0441\u0430\u0439\u0442\u043e\u043c, \u043d\u0430\u043c \u0432\u0430\u0436\u043d\u0430 \u0412\u0430\u0448\u0430 \u043f\u043e\u0434\u0434\u0435\u0440\u0436\u043a\u0430.</p>\n\n<p>\u0411\u043b\u0430\u0433\u043e\u0434\u0430\u0440\u043d\u043e\u0441\u0442\u044c \u0437\u0430 \u0443\u0440\u043e\u043a\u0438 \u0438\u0434\u0435\u0442 \u043d\u0430 \u0442\u0435\u0445\u043d\u0438\u0447\u0435\u0441\u043a\u043e\u0435 \u043e\u0431\u0435\u0441\u043f\u0435\u0447\u0435\u043d\u0438\u0435 \u0441\u0430\u0439\u0442\u0430 <a\n        id="serversMapImageLink" tabindex="0"\n        class="fas fa-info-circle text-primary"\n        style="position: relative;top: 1px;"></a> \u0438 \u0432\u043e\u0437\u043d\u0430\u0433\u0440\u0430\u0436\u0434\u0435\u043d\u0438\u0435\n    \u0442\u0435\u043c, <a href="'+
