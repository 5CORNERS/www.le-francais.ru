...
["composter-01.mp3","composter-02.mp3","composter-03.mp3","composter-04.mp3"];if(!userlesson&&must_pay||NEED_PAYMENT&&!IS_AUTHENTICATED)window.addEventListener("lessonPlayerReady",function(){$(".audioplayer-download-button")[0].addEventListener("click",function(){d("download")});$("#lesson-audio")[0].addEventListener("ended",function(){d("ended")})}),$("[data-activate-lesson]").click(function(){d($(this).data("activate-lesson"))}),$("#tab-flash-cards").removeAttr("data-toggle"),$("#tab-exercises-de-lesson").removeAttr("data-toggle"),
$("#tab-exercise").removeAttr("data-toggle"),$("#tab-flash-cards").click(function(a){a.preventDefault();d("tab")}),$("#tab-exercises-de-lesson").click(function(a){a.preventDefault();d("tab")}),$("#tab-exercise").click(function(a){a.preventDefault();d("tab")})}else if(!IS_AUTHENTICATED&&5<LESSON_NUMBER)$(window).one("lessonPlayerReady",function(){$(".audioplayer-download-button").on("click",function(a){a.preventDefault();$.ajax({url:Urls["modal:download_login_required"](),type:"GET",data:{redirect_url:window.location.pathname},
datatype:"html",success:function(a){$(a).modal("show")}})})});$(".coffee-proceed").on("click",function(){$(".modal").modal("hide");$.ajax({type:"POST",url:Urls["coffee:give_me_a_coffee"](),data:{lesson_number:LESSON_NUMBER,csrfmiddlewaretoken:CSRF_TOKEN},async:!e,datatype:"json",cache:!1,headers:{"cache-control":"no-cache"},success:function(a){"SUCCESS"===a.result?((new Audio(COFFEE_SOUND_URL)).play(),$("#give-me-a-coffee-success-message").html(a.description),$("#give-me-a-coffee-complete-modal").modal("show"),
c(),reloadPage(LESSON_NUMBER)):"ALREADY"===a.result?($("#give-me-a-coffee-fail-message").html(a.description),$("#give-me-a-coffee-fail-modal").modal("show"),c(),reloadPage(LESSON_NUMBER)):($("#give-me-a-coffee-fail-message").html(a.description),$("#give-me-a-coffee-fail-modal").modal("show"))},error:function(a,b){$("#give-me-a-coffee-fail-message").html(b);$("#give-me-a-coffee-fail-modal").modal("show")}})});addEventListener("strictDownload",function(a){$("#strictDownloadModal").modal("show")});addEventListener("unhiddenWasPlaying",
function(a){$("#hiddenWasListeningModal").modal("show")})}); //# sourceMappingURL=lessons.map
