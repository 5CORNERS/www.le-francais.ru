...
a(),reloadPage(LESSON_NUMBER)):"ALREADY"===b.result?($("#give-me-a-coffee-fail-message").html(b.description),$("#give-me-a-coffee-fail-modal").modal("show"),a(),reloadPage(LESSON_NUMBER)):($("#give-me-a-coffee-fail-message").html(b.description),$("#give-me-a-coffee-fail-modal").modal("show"))},error:function(a,b){$("#give-me-a-coffee-fail-message").html(b);$("#give-me-a-coffee-fail-modal").modal("show")}})});!0===!NEED_PAYMENT&&!0===must_pay&&addEventListener("strictDownload",function(a){$("#strictDownloadModal").modal("show")});
addEventListener("unhiddenWasPlaying",function(a){$("#hiddenWasListeningModal").modal("show")});$("#unhiddenWasPlaying").click(function(a){$("#lessonAudioBlock").find("#playpause").click()});$("#strictDownloadModelWhyThis").popover({content:'\u0412\u0430\u0448\u0430 \u043f\u043e\u0434\u0434\u0435\u0440\u0436\u043a\u0430 \u0438\u0434\u0435\u0442 \u043d\u0430 \u0442\u0435\u0445\u043d\u0438\u0447\u0435\u0441\u043a\u043e\u0435 \u043e\u0431\u0435\u0441\u043f\u0435\u0447\u0435\u043d\u0438\u0435 \u0441\u0430\u0439\u0442\u0430 <a id="serversMapImageLink" tabindex="0"\n                                                         class="fas fa-info-circle text-primary"\n                                                         style="position: relative;top: 1px;"></a> \u0438 \u0432\u043e\u0437\u043d\u0430\u0433\u0440\u0430\u0436\u0434\u0435\u043d\u0438\u0435 \u0442\u0435\u043c, <a href="'+
...
function(){$("#strictDownloadModal").modal("show")});$("#strictDownloadModal").modal("hide")})});$("#StrictDownloadModelCoffeeButton").on("click",function(){$("#strictDownloadModal").modal("hide")})}); //# sourceMappingURL=lessons.map
