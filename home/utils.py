...
def message_left(n, form1='чашечка', form2='чашечки', form5='чашечек'):
    ...
    if n == 0:
        ...
        return 'У вас есть ещё {0} {1}. Учите французский и получайте удовольствие! :)'.format(str(n), form1)
    elif n10 in [2, 3, 4] and n100 not in [12, 13, 14]:
        return 'У вас есть ещё {0} {1}. Учите французский и получайте удовольствие! :)'.format(str(n), form2)
    else:
        return 'У вас есть ещё {0} {1}. Учите французский и получайте удовольствие! :)'.format(str(n), form5)
