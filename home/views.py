        ...
        if request.user.saw_message and request.user.must_pay and request.GET.get(
            ...
            if not request.user.low_price:
                data = dict(tickets=True, cards=[
                    ...
                    dict(title="5 билетов", image="images/tickets/tickets-5-490.png",
                         description=None, price1="по 98 ₽", price2=490,
                         item_id=7),
                    dict(title="10 билетов", image="images/tickets/tickets-10-890.png",
                         description=None, price1="по 89 ₽", price2=890,
                         item_id=8),
                    dict(title="20 билетов", image="images/tickets/tickets-20-1560.png",
                         description=None, price1="по 78 ₽", price2=1560,
                         item_id=9),
                    dict(title="50 билетов", image="images/tickets/tickets-50-2950.png",
