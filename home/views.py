        ...
        if request.user.saw_message and request.user.must_pay and request.GET.get(
            ...
            if not request.user.low_price:
                data = dict(tickets=True, cards=[
                    dict(title="1 билет", image="images/tickets/ticket-1-149.png",
                         description=None,
                         price1="<s>По цене стаканчика кофе в <b>McDonalds</b></s>",
                         price2=149, item_id=6),
                    dict(title="4 билета", image="images/tickets/tickets-4.png",
                         description=None, price1="по 123 ₽", price2=490,
                         item_id=7),
                    dict(title="8 билетов", image="images/tickets/tickets-8.png",
                         description=None, price1="по 111 ₽", price2=890,
                         item_id=8),
                    dict(title="16 билетов", image="images/tickets/tickets-16.png",
                         description=None, price1="по 98 ₽", price2=1560,
                         item_id=9),
                    dict(title="40 билетов", image="images/tickets/tickets-40.png",
                         description=None, price1="по 74 ₽", price2=2950,
                         item_id=10),
                ])
            ...
            data = dict(tickets=False, cards=[
                dict(title="1 чашечка", image="images/coffee_1.png",
                     ...
                     price2=149,
                     item_id=1),
                dict(title="4 чашечки", image="images/tickets/coffee cup-4.png",
                     description=None,
                     price1=f"по 123 ₽", price2=490, item_id=2),
                dict(title="8 чашечек", image="images/tickets/coffee cup-8.png",
                     description=None, price1=f"по 111 ₽", price2=890,
                     item_id=3),
                dict(title="16 чашечек", image="images/tickets/coffee cup-16.png",
                     description=None, price1=f"по 98 ₽", price2=1560,
                     item_id=4),
                dict(title="40 чашечек", image="images/tickets/coffee cup-40.png",
                     description='''Хватит, чтобы угощать целый год.''',
                     price1=f"по 74 ₽", price2=2950, item_id=5),
            ])
