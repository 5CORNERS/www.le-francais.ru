# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2017-08-22 12:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='profile',
            name='icq',
            field=models.CharField(blank=True, max_length=10, null=True, validators=[django.core.validators.RegexValidator(regex='\\d+')], verbose_name='ICQ Number'),
        ),
        migrations.AlterField(
            model_name='profile',
            name='language',
