...
class ChangeUsernameTestCase(TestCase):
    def setUp(self):
        User.objects.create_user(username='username1', email='username1@example.com', password='password1')
        User.objects.create_user(username='username2', email='username2@example.com', password='password2')
