...
def notification_list_to_dict(notifications: list, user, add_self):
	return [notification.to_dict(user, add_self) for notification in notifications]
...
def get_new_notifications(request):
	...
	data = {'notification_list': notification_list_to_dict(notifications, user, False)}
	return JsonResponse(data)
