var notificationsUpdateDatetime=0;function ifHasNewNotification(a){$.ajax(Urls["notifications:has_new_notifications"](),{type:"POST",dataType:"json",contentType:"application/json; charset=utf-8",data:JSON.stringify({datetime:notificationsUpdateDatetime}),success:function(b){b.hasNewNotifications&&a.call()}})}
