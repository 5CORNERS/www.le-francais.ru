...
this.interval);return this}};return b.start(!0)};$(document).ready(function(){$(".notify-dropdown .nav-link").on("click",get_drop_content);var a=setBadgeUpdater(6E4);document.addEventListener("visibilitychange",function(){"visible"===document.visibilityState?a.start():a.stop()})});function check_notifications(a){0<a.length&&($("#notify-badge-nav").hide().html("0"),$.ajax(Urls["notifications:check_list"](),{type:"POST",data:{pks:a.toString()}}))}
