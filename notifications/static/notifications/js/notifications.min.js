$(document).ready(function(){$(".notify-dropdown").on("click",get_drop_content);setInterval(update_badge,25E3)});function check_notifications(a){0<a.length&&($("#notify-badge-nav").hide().html("0"),$.ajax(Urls["notifications:check_list"](),{type:"POST",data:{pks:a.toString()}}))}function update_badge(){$.ajax({url:Urls["notifications:get_new_count"](),success:function(a){0<a?$("#notify-badge-nav").html(a).show():$("#notify-badge-nav").html(a).hide()}})}
