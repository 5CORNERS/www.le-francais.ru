...
function applyFilters(a,b){$.each(b[a],function(a,b){var c=$("#"+a);$.each(b.attrs,function(a,b){c.attr(a,b)});"undefined"!==typeof b.value&&select(c,b.value);"undefined"!==typeof b.checked&&toggle(c,b.checked)})}function bind_play_icons(){var a=$(".play");a.unbind();a.click(function(a){a=$(a.target).data("audiosrc");voice(a)})}
...
function get_selected(a){a=a.api().column(0).checkboxes.selected();var b=[];$.each(a,function(a,d){b.push(d)});return b}function get_selected_filtered(a){var b=get_selected(a),c=get_filtered(a),d=[];b.forEach(function(a){c.includes(a)&&d.push(a)});return d}function get_filtered(a){return a.api().rows({search:"applied"}).data().pluck(0).toArray()}var audio=void 0;function voice(a){audio=new Audio(a);audio.play()}
$(document).ready(function(){$("#filterWordsForm").submit(function(a){a.preventDefault();updateTable()});$("#startApp").on("click",function(){var a=get_selected_filtered(dt);0===a.length?($("#startApp").popover({content:"\u0412\u044b \u043d\u0435 \u0432\u044b\u0431\u0440\u0430\u043b\u0438 \u043d\u0438 \u043e\u0434\u043d\u043e\u0433\u043e \u0441\u043b\u043e\u0432\u0430",placement:"auto",trigger:"manual",container:"body",boundary:"viewport"}).popover("show"),setTimeout(function(){$("#startApp").popover("hide").popover("dispose")},
2E3)):($("#startApp").popover("dispose"),$.ajax(Urls["dictionary:app"](),{type:"POST",contentType:"application/json",dataType:"json",data:JSON.stringify({words:a,csrfmiddlewaretoken:csrf}),error:errorLoading,success:function(a){window.location.href=Urls["dictionary:app"]()},beforeSend:emptyTable("")}))});$("#markWords").on("click",function(){0===get_selected_filtered(dt).length?($("#markWords").popover({content:"\u0412\u044b \u043d\u0435 \u0432\u044b\u0431\u0440\u0430\u043b\u0438 \u043d\u0438 \u043e\u0434\u043d\u043e\u0433\u043e \u0441\u043b\u043e\u0432\u0430",
...
dataType:"json",data:JSON.stringify({words:get_selected_filtered(dt),csrfmiddlewaretoken:csrf}),success:function(a){updateTable()},error:errorLoading,beforeSend:tableReloading}))});$("#main-frm").on("submit",function(a){var b=this,c=dt.api().column(0).checkboxes.selected();$.each(c,function(a,c){$(b).append($("<input>").attr("type","hidden").attr("name","id[]").val(c))});a.preventDefault()});init_packets&&($("#id_packets").selectpicker("val",init_packets),updateTable());loadFilterButton.init()});
