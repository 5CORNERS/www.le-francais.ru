...
function tableReloading(){$table.find("tbody").empty().html('<tr><td colspan="5" style="text-align:center"><div class="row"><div class="col-12"><h5 style="margin:1rem">\u0417\u0430\u0433\u0440\u0443\u0436\u0430\u0435\u043c \u0441\u043b\u043e\u0432\u0430...</h5></div><div class="col-12"><img src="/static/images/loading_icon.gif"></div></div></td></tr>')}var tableFilters={beforeLoad:{},afterLoad:{},selectAfterFilter:{}},savingFiltersEnabled=!0;function toggle(a,b){b!==a.prop("checked")&&a.click()}
function select(a,b){b!==a.val()&&(a.val(b),a.change())}function saveFilters(a,b,c){savingFiltersEnabled&&($.each(b,function(b,d){tableFilters[a][d]={};tableFilters[a][d].attrs={};var f=$("#"+d);$.each(c,function(c,b){(c=f.attr(b))||(c=null);tableFilters[a][d].attrs[b]=c});f.val()?tableFilters[a][d].value=f.val():tableFilters[a][d].value=void 0;"undefined"!==typeof f.prop("checked")?tableFilters[a][d].checked=f.prop("checked"):tableFilters[a][d].checked=void 0}),pushFilters())}
function pushFilters(){$.ajax(Urls["dictionary:save_filters"](),{method:"POST",data:JSON.stringify({filters:tableFilters}),contentType:"application/json",dataType:"json"})}function getFilters(){$.ajax(Urls["dictionary:get_filters"](),{method:"POST",dataType:"json",async:!1,success:function(a){tableFilters=a},statusCode:{404:function(){}}})}
function applyFilters(a,b){$.each(b[a],function(a,b){var c=$("#"+a);$.each(b.attrs,function(a,b){c.attr(a,b)});"undefined"!==typeof b.value&&select(c,b.value);"undefined"!==typeof b.checked&&toggle(c,b.checked)})}function loadAndFilter(){savingFiltersEnabled=!1;getFilters();applyFilters("beforeLoad",tableFilters);updateTable(function(){applyFilters("afterLoad",tableFilters);applyFilters("selectAfterFilter",tableFilters);savingFiltersEnabled=!0})}
...
$.each(c,function(a,c){$(b).append($("<input>").attr("type","hidden").attr("name","id[]").val(c))});a.preventDefault()});$("#getAndApplyFilters").on("click",loadAndFilter)});
