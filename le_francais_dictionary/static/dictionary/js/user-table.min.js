...
function updateTable(a,b){b=void 0===b?50:b;var c=$("#filterWordsForm"),d=Urls["dictionary:my_words"]();$.ajax(d,{type:"POST",dataType:"json",data:c.serialize(),success:function(c){$table.html(c.table);void 0!==dt&&(dt.api().destroy(),$selectStars.remove());$table.DataTable({dom:"<'row'<'col-sm-12 mb-2'tr>><'row'<'#alert.col-12'><'#info.col-12'i><'col-sm-12 col-md-5'l><'col-sm-12 col-md-7'p>>",columnDefs:[{targets:0,render:function(a,b,c,d){"display"===b&&(a='<div class="checkbox"><input type="checkbox" id="checkbox-select-'+
