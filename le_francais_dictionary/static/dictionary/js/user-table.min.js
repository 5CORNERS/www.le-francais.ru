...
function(a,b,c,d){if(savingFiltersEnabled){tableFilters.selectAfterFilter={};var e=[];$.each(get_selected_filtered(dt),function(a,b){e.push("checkbox-select-"+b)});saveFilters("selectAfterFilter",e,["checked"])}});void 0!==a&&a()}})},error:errorLoading,beforeSend:tableReloading});$(".undertable").show();$(".uppertable").show()}
