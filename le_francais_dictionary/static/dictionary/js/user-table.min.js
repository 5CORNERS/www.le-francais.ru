...
var tableFiltersInit={beforeLoad:{},afterLoad:{},selectAfterFilter:{}},tableFilters=tableFiltersInit.valueOf(),tableFiltersLoaded=!1,savingFiltersEnabled=!0,loadFilterButton={$button:{},getFilters:function(){$.ajax(Urls["dictionary:get_filters"](),{method:"POST",dataType:"json",async:!1,beforeSend:function(){loadFilterButton.setStateLoading()},statusCode:{200:function(a){tableFilters=a;tableFiltersLoaded=!0},404:function(){tableFilters=tableFiltersInit.valueOf();tableFiltersLoaded=!1},500:function(){tableFilters=
tableFiltersInit.valueOf();tableFiltersLoaded=!1}},complete:function(){loadFilterButton.afterGetFilters()}})},saveFilters:function(){$.ajax(Urls["dictionary:save_filters"](),{method:"POST",data:JSON.stringify({filters:tableFilters}),contentType:"application/json",dataType:"json",beforeSend:function(){loadFilterButton.setStateSaving()},success:function(a){loadFilterButton.afterSavingFilters()},error:function(a){loadFilterButton.afterSavingError()}})},init:function(){this.$button=$("#getAndApplyFilters");
this.$button.on("click",loadAndFilter);this.getFilters();this.readyText="\u041f\u043e\u0432\u0442\u043e\u0440\u0438\u0442\u044c \u043f\u043e\u0441\u043b\u0435\u0434\u043d\u044e\u044e \u0432\u044b\u0431\u043e\u0440\u043a\u0443";this.loadingText='<i class="fa fa-sync fa-spin"></i>'+this.readyText;this.savingText='<i class="fa fa-sync fa-spin"></i>'+this.readyText;this.savedText=this.readyText;this.errorText='<i class="fa fa-exclamation-triangle"></i>'+this.readyText},disable:function(){this.$button.attr("disabled",
