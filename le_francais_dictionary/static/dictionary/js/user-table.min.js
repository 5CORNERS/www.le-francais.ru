...
var tableFiltersInit={beforeLoad:{},afterLoad:{},selectAfterFilter:{}},tableFilters=tableFiltersInit.valueOf(),tableFiltersLoaded=!1,savingFiltersEnabled=!0,loadFilterButton={$button:{},getFilters:function(){this.setStateLoading();$.ajax(Urls["dictionary:get_filters"](),{method:"POST",dataType:"json",async:!1,statusCode:{200:function(a){tableFilters=a;tableFiltersLoaded=!0},404:function(){tableFilters=tableFiltersInit.valueOf();tableFiltersLoaded=!1},500:function(){tableFilters=tableFiltersInit.valueOf();
tableFiltersLoaded=!1}},complete:function(){loadFilterButton.afterGetFilters()}})},saveFilters:function(){this.setStateSaving();$.ajax(Urls["dictionary:save_filters"](),{method:"POST",data:JSON.stringify({filters:tableFilters}),contentType:"application/json",dataType:"json",success:function(a){loadFilterButton.afterSavingFilters()},error:function(a){loadFilterButton.afterSavingError()}})},readyText:"\u041f\u043e\u0432\u0442\u043e\u0440\u0438\u0442\u044c \u043f\u043e\u0441\u043b\u0435\u0434\u043d\u044e\u044e \u0432\u044b\u0431\u043e\u0440\u043a\u0443",
loadingText:'<i class="fa fa-sync fa-spin"></i>'+this.readyText,savingText:'<i class="fa fa-sync fa-spin"></i>'+this.readyText,savedText:this.readyText,errorText:'<i class="fa fa-exclamation-triangle"></i>'+this.readyText,init:function(){this.$button=$("#getAndApplyFilters");this.$button.on("click",loadAndFilter);this.getFilters()},disable:function(){this.$button.attr("disabled","").addClass("disabled")},setText:function(a){this.$button.empty().html(a)},setStateReady:function(){this.setText(this.readyText)},
setStateSaving:function(){this.setText(this.savingText)},setStateSaved:function(){this.setText(this.savedText)},setStateLoading:function(){this.setText(this.loadingText)},setStateNoFilters:function(){this.setText(this.readyText);this.disable()},afterGetFilters:function(){tableFiltersLoaded?loadFilterButton.setStateReady():loadFilterButton.setStateNoFilters()},afterSavingFilters:function(){this.setStateSaved()},afterSavingError:function(){this.setStateError(function(){loadFilterButton.saveFilters()})},
...
function saveFilters(a,b,c){savingFiltersEnabled&&($.each(b,function(b,d){tableFilters[a][d]={};tableFilters[a][d].attrs={};var f=$("#"+d);$.each(c,function(c,b){(c=f.attr(b))||(c=null);tableFilters[a][d].attrs[b]=c});f.val()?tableFilters[a][d].value=f.val():tableFilters[a][d].value=void 0;"undefined"!==typeof f.prop("checked")?tableFilters[a][d].checked=f.prop("checked"):tableFilters[a][d].checked=void 0}),loadFilterButton.saveFilters())}
function applyFilters(a,b){$.each(b[a],function(a,b){var c=$("#"+a);$.each(b.attrs,function(a,b){c.attr(a,b)});"undefined"!==typeof b.value&&select(c,b.value);"undefined"!==typeof b.checked&&toggle(c,b.checked)})}function loadAndFilter(){savingFiltersEnabled=!1;loadFilterButton.getFilters();applyFilters("beforeLoad",tableFilters);updateTable(function(){applyFilters("afterLoad",tableFilters);applyFilters("selectAfterFilter",tableFilters);savingFiltersEnabled=!0})}
function updateTable(a){var b=$("#filterWordsForm"),c=Urls["dictionary:my_words"]();$.ajax(c,{type:"POST",dataType:"json",data:b.serialize(),success:function(b){$table.html(b.table);void 0!==dt&&(dt.api().destroy(),$selectStars.remove());$table.DataTable({dom:"<'row'<'col-sm-12 mb-2'tr>><'row'<'#alert.col-12'><'#info.col-12'i><'col-sm-12 col-md-5'l><'col-sm-12 col-md-7'p>>",columnDefs:[{targets:0,render:function(a,b,c,e){"display"===b&&(a='<div class="checkbox"><input type="checkbox" id="checkbox-select-'+
a+'" class="dt-checkboxes"><label></label></div>');return a},checkboxes:{selectRow:!0,selectAllRender:'<div class="checkbox"><input type="checkbox" id="checkbox-select-all" class="dt-checkboxes"><label></label></div>'}}],select:"multi+shift",searching:!0,ordering:!1,paging:!0,pageLength:50,lengthMenu:[[50,100,250,500,-1],[50,100,250,500,"\u0412\u0441\u0435"]],language:{processing:"\u041f\u043e\u0434\u043e\u0436\u0434\u0438\u0442\u0435...",search:"\u041f\u043e\u0438\u0441\u043a:",lengthMenu:"\u041f\u043e\u043a\u0430\u0437\u044b\u0432\u0430\u0442\u044c: _MENU_",
...
function(a,b,c,d){tableFilters.selectAfterFilter={};var e=[];$.each(get_selected_filtered(dt),function(a,b){e.push("checkbox-select-"+b)});saveFilters("selectAfterFilter",e,["checked"])});void 0!==a&&a()}})},error:errorLoading,beforeSend:tableReloading});$(".undertable").show();$(".uppertable").show()}
...
function get_selected(a){a=a.api().column(0).checkboxes.selected();var b=[];$.each(a,function(a,e){b.push(e)});return b}function get_selected_filtered(a){var b=get_selected(a),c=get_filtered(a),e=[];b.forEach(function(a){c.includes(a)&&e.push(a)});return e}function get_filtered(a){return a.api().rows({search:"applied"}).data().pluck(0).toArray()}
