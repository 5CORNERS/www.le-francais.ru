...
!function() {
    ...
    e.prototype = {
        ...
        _setupCodecs: function() {
            var e, n, t, o, r = this || A, a = null;
            try {
                a = "undefined" != typeof Audio ? new Audio() : null;
            } catch (e) {
                return r;
            }
            return a && "function" == typeof a.canPlayType && (e = a.canPlayType("audio/mpeg;").replace(/^no$/, ""), 
            n = (n = (t = r._navigator ? r._navigator.userAgent : "").match(/OPR\/(\d+)/g)) && parseInt(n[0].split("/")[1], 10) < 33, 
            o = -1 !== t.indexOf("Safari") && -1 === t.indexOf("Chrome"), t = t.match(/Version\/(.*?) /), 
            o = o && t && parseInt(t[1], 10) < 15, r._codecs = {
                mp3: !(n || !e && !a.canPlayType("audio/mp3;").replace(/^no$/, "")),
                mpeg: !!e,
                ...
                weba: !(o || !a.canPlayType('audio/webm; codecs="vorbis"').replace(/^no$/, "")),
                webm: !(o || !a.canPlayType('audio/webm; codecs="vorbis"').replace(/^no$/, "")),
    ...
    var A = new e(), a = (n.prototype = {
        ...
        play: function(n, t) {
            ...
            var d, s, _, l, c = Math.max(0, 0 < u._seek ? u._seek : o._sprite[n][0] / 1e3), p = Math.max(0, (o._sprite[n][0] + o._sprite[n][1]) / 1e3 - c), f = 1e3 * p / Math.abs(u._rate), m = o._sprite[n][0] / 1e3, h = (o._sprite[n][0] + o._sprite[n][1]) / 1e3, v = (u._sprite = n, 
            u._ended = !1, function() {
                u._paused = !1, u._seek = c, u._start = m, u._stop = h, u._loop = !(!u._loop && !o._sprite[n][2]);
            });
            if (!(h <= c)) return d = u._node, o._webAudio ? (_ = function() {
            ...
            o.once("resume", _), o._clearTimer(u._id))) : (s = function() {
                ...
                try {
                    ...
                    d.playbackRate = u._rate, d.paused ? o._emit("playerror", u._id, "Playback was unable to start. This is most commonly an issue on mobile devices and Chrome where playback was not within a user interaction.") : "__default" !== n || u._loop ? o._endTimers[u._id] = setTimeout(o._ended.bind(o, u), f) : (o._endTimers[u._id] = function() {
        ...
        pause: function(e) {
            ...
            }); else for (var t = n._getSoundIds(e), o = 0; o < t.length; o++) {
                n._clearTimer(t[o]);
        ...
        stop: function(e, n) {
            ...
            }); else for (var o = t._getSoundIds(e), r = 0; r < o.length; r++) {
                t._clearTimer(o[r]);
        ...
        fade: function(e, n, t, o) {
            var r = this;
            if ("loaded" !== r._state || r._playLock) r._queue.push({
                event: "fade",
                action: function() {
                    r.fade(e, n, t, o);
                }
        ...
        rate: function() {
            ...
            if ("loaded" !== n._state || n._playLock) n._queue.push({
                ...
                r._playStart = n._webAudio ? A.ctx.currentTime : r._playStart), 
                r._rate = e, n._webAudio && r._node && r._node.bufferSource ? r._node.bufferSource.playbackRate.setValueAtTime(e, A.ctx.currentTime) : r._node && (r._node.playbackRate = e), 
        ...
        _ended: function(e) {
            var n, t = this, o = e._sprite;
            return !t._webAudio && e._node && !e._node.paused && !e._node.ended && e._node.currentTime < e._stop ? setTimeout(t._ended.bind(t, e), 100) : (o = !(!e._loop && !t._sprite[o][2]), 
            t._emit("end", e._id), !t._webAudio && o && t.stop(e._id, !0).play(e._id), 
            t._webAudio && o && (t._emit("play", e._id), e._seek = e._start || 0, 
            e._rateSeek = 0, e._playStart = A.ctx.currentTime, n = 1e3 * (e._stop - e._start) / Math.abs(e._rate), 
            t._endTimers[e._id] = setTimeout(t._ended.bind(t, e), n)), t._webAudio && !o && (e._paused = !0, 
            e._ended = !0, e._seek = e._start || 0, e._rateSeek = 0, t._clearTimer(e._id), 
            t._cleanBuffer(e._node), A._autoSuspend()), t._webAudio || o || t.stop(e._id, !0)), 
            t;
        },
        ...
        var e = n._src;
        if (i[e]) n._duration = i[e].duration, _(n); else if (/^data:[^;]+;base64,/.test(e)) {
...
function() {
    ...
    HowlerGlobal.prototype.stereo = function(e) {
        var n = this;
        if (n.ctx && n.ctx.listener) for (var t = n._howls.length - 1; 0 <= t; t--) n._howls[t].stereo(e);
        return n;
    }, HowlerGlobal.prototype.pos = function(e, n, t) {
        var o = this;
        if (o.ctx && o.ctx.listener) {
            if (n = "number" != typeof n ? o._pos[1] : n, t = "number" != typeof t ? o._pos[2] : t, 
            "number" != typeof e) return o._pos;
            o._pos = [ e, n, t ], void 0 !== o.ctx.listener.positionX ? (o.ctx.listener.positionX.setTargetAtTime(o._pos[0], Howler.ctx.currentTime, .1), 
        ...
        if (i.ctx && i.ctx.listener) {
            ...
            if (n = "number" != typeof n ? u[1] : n, t = "number" != typeof t ? u[2] : t, 
            o = "number" != typeof o ? u[3] : o, r = "number" != typeof r ? u[4] : r, 
            a = "number" != typeof a ? u[5] : a, "number" != typeof e) return u;
            i._orientation = [ e, n, t, o, r, a ], void 0 !== i.ctx.listener.forwardX ? (i.ctx.listener.forwardX.setTargetAtTime(e, Howler.ctx.currentTime, .1), 
        ...
        var t = this;
        if (t._webAudio) if ("loaded" !== t._state) t._queue.push({
            event: "stereo",
            action: function() {
                t.stereo(e, n);
            }
            ...
            for (var r = t._getSoundIds(n), a = 0; a < r.length; a++) {
                ...
                if (i) {
                    ...
                    i._panner.positionZ.setValueAtTime(0, Howler.ctx.currentTime)) : i._panner.setPosition(e, 0, 0) : i._panner.pan.setValueAtTime(e, Howler.ctx.currentTime)), 
        ...
        var r = this;
        if (r._webAudio) if ("loaded" !== r._state) r._queue.push({
            event: "pos",
            action: function() {
                r.pos(e, n, t, o);
            }
            ...
            for (var a = r._getSoundIds(o), i = 0; i < a.length; i++) {
                ...
                if (u) {
                    ...
                    u._panner.positionZ.setValueAtTime(t, Howler.ctx.currentTime)) : u._panner.setPosition(e, n, t)), 
                    r._emit("pos", u._id);
                }
            }
        }
        ...
        if (t._webAudio) {
            ...
            }, (a = i._panner) || (i._pos || (i._pos = t._pos || [ 0, 0, -.5 ]), 
            s(i, "spatial"), a = i._panner), a.coneInnerAngle = r.coneInnerAngle, 
            a.coneOuterAngle = r.coneOuterAngle, a.coneOuterGain = r.coneOuterGain, 
            a.distanceModel = r.distanceModel, a.maxDistance = r.maxDistance, a.refDistance = r.refDistance, 
            a.rolloffFactor = r.rolloffFactor, a.panningModel = r.panningModel);
        }
        return t;
