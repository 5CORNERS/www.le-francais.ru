 ...
 */
    function(R) {
        ...
        for (e in p = D.support = {}, W = D.isXML = function(e) {
            ...
            var t, n = [], r = 0, i = 0;
            if (l = !p.detectDuplicates, u = !p.sortStable && e.slice(0), e.sort(X), 
            l) {
            ...
            pseudos: {
                ...
                lang: L(function(n) {
                    ...
                    n = n.replace(j, f).toLowerCase(), function(e) {
                        var t;
                        do {
        ...
        return me.prototype = b.filters = b.pseudos, b.setFilters = new me(), d = D.tokenize = function(e, t) {
            ...
            for (a = e, s = [], u = b.preFilter; a; ) {
                ...
                s.push(i = [])), n = !1, (r = ne.exec(a)) && (n = r.shift(), i.push({
                    value: n,
                    type: r[0].replace(m, " ")
            ...
            if (n = n || [], 1 === c.length) {
                ...
                !b.relative[s = a.type]); ) if ((u = b.find[s]) && (r = u(a.matches[0].replace(j, f), ce.test(o[0].type) && ye(t.parentNode) || t))) {
    ...
    C.Callbacks = function(r) {
        ...
        var o, t, a, s, u = [], l = [], c = -1, f = {
            ...
            fireWith: function(e, t) {
                return s || (t = [ e, (t = t || []).slice ? t.slice() : t ], l.push(t), 
                o || i()), this;
            },
            fire: function() {
        ...
        when: function(e) {
            function t(t) {
                return function(e) {
                    i[t] = this, o[t] = 1 < arguments.length ? s.call(arguments) : e, 
                    --n || a.resolveWith(i, o);
                };
            }
    ...
    function xe(e, t, n, r) {
        ...
        if (c && c[3] !== l) {
            for (l = l || c[3], c = +(u /= 2) || 1; a--; ) C.style(e, t, c + l), 
    ...
    function A(e, t) {
        ...
        i = i.nodeName, (a = be[i]) || (o = o.body.appendChild(o.createElement(i)), 
        a = C.css(o, "display"), o.parentNode.removeChild(o), be[i] = a = "none" === a ? "block" : a)))) : "none" !== n && (s[u] = "none", 
        b.set(r, "display", n)));
    ...
    function ke(e, t, n, r, i) {
        for (var o, a, s, u, l, c = t.createDocumentFragment(), f = [], p = 0, d = e.length; p < d; p++) if ((o = e[p]) || 0 === o) if ("object" === h(o)) C.merge(f, o.nodeType ? [ o ] : o); else if (Se.test(o)) {
            ...
            s = N[s] || N._default, a.innerHTML = s[1] + C.htmlPrefilter(o) + s[2], 
    ...
    C.event = {
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    e = this || e;
                    return we.test(e.type) && e.click && u(e, "input") && De(e, "click", n), 
                    !1;
                },
                trigger: function(e) {
                    e = this || e;
        ...
        off: function(e, t, n) {
            ...
            t = void 0), !1 === n && (n = d), this.each(function() {
    ...
    function D(n, r, i, o) {
        ...
        t || o)) {
            for (s = (a = C.map(j(e, "script"), Pe)).length; c < f; c++) u = e, 
            c !== p && (u = C.clone(u, !0, !0), s && C.merge(a, j(u, "script"))), 
            i.call(n[c], u, c);
    ...
    C.extend({
        ...
        clone: function(e, t, n) {
            ...
            r = 0, i = (o = j(e)).length; r < i; r++) s = o[r], u = a[r], l = void 0, 
    ...
    function Qe() {
        ...
        Xe = 12 === Je(e.marginLeft), i.style.right = "60%", ze = 36 === Je(e.right), 
        $e = 36 === Je(e.width), i.style.position = "absolute", _e = 12 === Je(i.offsetWidth / 3), 
        S.removeChild(Ve), i = null);
    }
    function Je(e) {
    ...
    C.extend(y, {
        ...
        reliableTrDimensions: function() {
            var e, t, n;
            return null == Ue && (e = T.createElement("table"), t = T.createElement("tr"), 
            ...
            n.style.display = "block", S.appendChild(e).appendChild(t).appendChild(n), 
    ...
    function lt(e, t, n, r, i, o) {
        ...
        for (;a < 4; a += 2) "margin" === n && (u += C.css(e, n + p[a], !0, i)), 
        r ? ("content" === n && (u -= C.css(e, "padding" + p[a], !0, i)), "margin" !== n && (u -= C.css(e, "border" + p[a] + "Width", !0, i))) : (u += C.css(e, "padding" + p[a], !0, i), 
    ...
    C.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                o = "number"), null != n && n == n && ("number" !== o || u || (n += i && i[3] || (C.cssNumber[s] ? "" : "px")), 
    ...
    function H(i, e, t) {
        ...
        for (r in y) if (s = m[a = x(r)], u = y[r], Array.isArray(u) && (s = u[1], 
        u = y[r] = u[0]), r !== a && (y[a] = u, delete y[r]), (l = C.cssHooks[a]) && "expand" in l) for (r in u = l.expand(u), 
    ...
    a.type = "checkbox", y.checkOn = "" !== a.value, y.optSelected = L.selected, 
    (a = T.createElement("input")).value = "t", a.type = "radio", y.radioValue = "t" === a.value;
    var vt, xt = C.expr.attrHandle, bt = (C.fn.extend({
        ...
        attrHooks: {
            type: {
                set: function(e, t) {
                    var n;
                    if (!y.radioValue && "radio" === t && u(e, "input")) return n = e.value, 
    ...
    var Et = /\r/g, St = (C.fn.extend({
        ...
        trigger: function(e, t, n, r) {
            ...
            l = C.event.special[p] || {}, r || !l.trigger || !1 !== l.trigger.apply(n, t))) {
                ...
                e.type = 1 < i ? a : l.bindType || p, (u = (b.get(h, "events") || Object.create(null))[e.type] && b.get(h, "handle")) && u.apply(h, t), 
                ...
                C.event.triggered = p, e.isPropagationStopped() && c.addEventListener(p, Ct), 
                n[p](), e.isPropagationStopped() && c.removeEventListener(p, Ct), 
                C.event.triggered = void 0, o && (n[s] = o)), e.result;
            }
        },
    ...
    $t.href = kt.href, C.extend({
        ...
        ajax: function(e, t) {
            ...
            if (a = "abort", v.add(h.complete), b.done(h.success), b.fail(h.error), 
            u = zt(Ft, h, t, b)) {
            ...
            function s(e, t, n, r) {
                ...
                i = a.data, r = !(o = a.error))) : (o = s, !e && s || (s = "error", 
                ...
                v.fireWith(g, [ b, s ]), d && (y.trigger("ajaxComplete", [ b, h ]), 
    ...
    var Xt = {
        0: 200,
        1223: 204
    }, Vt = C.ajaxSettings.xhr(), Gt = (y.cors = !!Vt && "withCredentials" in Vt, 
    y.ajax = Vt = !!Vt, C.ajaxTransport(function(i) {
        var o, a;
    ...
    2 === e.childNodes.length), C.parseHTML = function(e, t, n) {
        ...
        return -1 < s && (r = O(e.slice(s)), e = e.slice(0, s)), v(t) ? (n = t, 
    ...
    return C.noConflict = function(e) {
        return w.$ === C && (w.$ = Kt), e && w.jQuery === C && (w.jQuery = Jt), 
        C;
