...
((e, t) => {
    ...
    }, F = t.push, x = t.indexOf, $ = {}, B = $.toString, _ = $.hasOwnProperty, z = _.toString, X = z.call(Object), g = {}, T = w.document, U = {
        type: !0,
        src: !0,
        nonce: !0,
        noModule: !0
    ...
    function $e(d, h, g, y, m, e) {
        return y && !y[A] && (y = $e(y)), m && !m[A] && (m = $e(m, e)), u(function(e, t, n, r) {
            var i, o, s, a, u = [], l = [], c = t.length, f = e || ((e, t, n) => {
    ...
    function ze(e, t, n, r) {
        ...
        return (l || _e(e, c))(r, t, !k, n, !t || ke.test(e) && He(t.parentNode) || t), 
        n;
    }
    ...
    }), C.find = N, C.expr[":"] = C.expr.pseudos, C.unique = C.uniqueSort, N.compile = _e, 
    ...
    var Qe, Je = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, Ke = ((C.fn.init = function(e, t, n) {
        if (e) {
            if (n = n || Qe, "string" != typeof e) return e.nodeType ? (this[0] = e, 
        ...
        return this;
    }).prototype = C.fn, Qe = C(T), /^(?:parents|prev(?:Until|All))/), Ze = {
        children: !0,
        contents: !0,
        next: !0,
        prev: !0
    ...
    function Ct(e, t) {
        ...
        (s = Tt[i = i.nodeName]) || (o = o.body.appendChild(o.createElement(i)), 
    ...
    var Ut, Vt, Gt, Yt, Qt, Jt, Kt, H, Zt = new RegExp("^(" + e + ")(?!px)[a-z%]+$", "i"), en = /^--/, tn = new RegExp(mt.join("|"), "i");
    function nn() {
        var e;
        ...
        Jt = 12 === rn(e.marginLeft), H.style.right = "60%", Yt = 36 === rn(e.right), 
    ...
    C.extend(g, {
        ...
        reliableTrDimensions: function() {
            var e, t, n;
            return null == Qt && (e = T.createElement("table"), t = T.createElement("tr"), 
    ...
    var Bn = /%20/g, _n = /#.*$/, zn = /([?&])_=[^&]*/, Xn = /^(.*?):[ \t]*([^\r\n]*)$/gm, Un = /^(?:GET|HEAD)$/, Vn = /^\/\//, Gn = {}, Yn = {}, Qn = "*/".concat("*"), Jn = T.createElement("a");
    function Kn(o) {
        return function(e, t) {
    ...
    Jn.href = On.href, C.extend({
        ...
        ajax: function(e, t) {
            ...
            Zn(Gn, h, t, b), !p) {
                ...
                l = h.url.replace(_n, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Bn, "+")) : (e = h.url.slice(l.length), 
